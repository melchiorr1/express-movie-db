...
router.get('/movie/:id/update', ensureAuthenticated, movieController.movie_update_get);

router.post('/movie/:id/update', ensureAuthenticated, movieController.movie_update_post);

router.get('/movie/:id/delete', ensureAuthenticated, movieController.movie_delete_get);

router.post('/movie/:id/delete', ensureAuthenticated, movieController.movie_delete_post);
